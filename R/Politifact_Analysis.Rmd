...
base_plot <- ggplot(data = lies_by_type, aes(x = reorder(Person, Percent),
  ...
  coord_flip() +
  labs(title = "<p style='color:#252525'>Percentage of Politifact Fact-Checks that were proved to be<br> <b style='color:#fecc5c'>Mostly False</b>, <b style='color:#feb24c'>False</b>, or a <b style='color:#f03b20'>Pants-on-Fire</b>lie</p>",
